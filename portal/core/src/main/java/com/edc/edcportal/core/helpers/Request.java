...
public class Request
{
	 ...
	 *
	 * @param  request  Request whose page path is to be returned ({@see org.apache.sling.api.SlingHttpServletRequest} Request).
	 ...
	 *
	 * @param  request  Request whose page is to be returned ({@see org.apache.sling.api.SlingHttpServletRequest} Request).
    ...
    public static Resource getCurrentPageResource(SlingHttpServletRequest request, String overridePath) {
        ...
        try {
            ...
            if (urlPage != null) {
                ...
                currentPage = request.getResourceResolver().resolve(LinkResolver.changeManualExternalURLtoInternal(currentPagePath));
