...
public class EloquaConnectionManagerConstants {
    ...
    public class CacheObjects {
        ...
        public static final String TOKEN_SENT_TO_EDCWEB = "token_sent_to_edc_web";
    ...
    public class EndPoints {
        ...
        public static final String INSTANCES_ENDPOINT_TRANSACTION_UNIQUE_CODE_QUERY_STRING  = "?search='ACC_ExternalID___Doc_ID1=";
        public static final String WEBINAR_PARTNER_1_QUERY_STRING = "'Webinar_Partner_CASL1=";
