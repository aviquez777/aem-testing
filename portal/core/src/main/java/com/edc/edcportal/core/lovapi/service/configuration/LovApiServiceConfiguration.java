package com.edc.edcportal.core.lovapi.service.configuration;
...
public @interface LovApiServiceConfiguration {
    ...
    @AttributeDefinition(name = "Get FI LOV API Base endpoint", description = "Financial Institution LOV API base endpooint to get requests", type = AttributeType.STRING)
