    ...
    this.validationRules = {
        required: function (el, country) {
            ...
            if (el.type === 'checkbox') {
                ...
                validValue = el.value.trim() !== '' || (country === 'other' && el.closest('.form-group.province') && !el.closest('.myedc-province')) || el.getAttribute('selected');
            }
        ...
        text: function (value, el, country) {
            var validValue = true,
                ...
                regexTextForFI = /^([a-zA-Z\u00C0-\u017F\s ,.'"´\()_-]?)+$/m,
            ...
            if (value !== '') {
                switch (validationRule) {
                    ...
                    case 'companyName':
                        ...
                        break;
                    case 'financialInstitution':
                        validValue = regexTextForFI.test(value);
                        break;
                    case 'postalCode':
                        if (country === 'can') {
