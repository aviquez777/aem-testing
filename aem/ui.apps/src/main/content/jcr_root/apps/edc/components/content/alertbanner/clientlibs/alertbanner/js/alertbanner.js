var alertBanner = (function () {
    ...
    // Public methods
    function init() {
        var alertBanners = document.querySelectorAll('.c-alert-banner:not([data-component-state="initialized"])');

        if (alertBanners) {
            alertBanners.forEach(function (elem) {
                _initialize(elem);
...
document.addEventListener('DOMContentLoaded', alertBanner.init);