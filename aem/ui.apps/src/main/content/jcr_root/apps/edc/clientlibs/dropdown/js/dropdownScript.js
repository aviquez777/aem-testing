...
EDC.dropdown = EDC.dropdown || new function () {
    'use strict';
    ...
    this.init = function (element) {
        ...
        function _initializeDropdown() {
            ...
            $(dropdown).dropdown('setting', 'onShow', function () {
                var inputs = document.querySelectorAll('form input[type="text"], form input[type="tel"], form input[type="email"], form textarea');
                ...
                if (isMultiple) {
                    dropdownText = element.querySelector('.text');
        ...
        function _destroyDropdown() {
            ...
            if (isMultiple && isSelected) {
                dropdownLabel = element.querySelector('.text');
        ...
        function _attachEvents() {
            var closeBtn = element.querySelector('.close-btn'),
                ...
                goAheadAndDestroy = !element.closest('.c-questionnaire') && !element.closest('.c-triage-tool');
