(function ($, $document) {
    ...
    function isRTEField($field) {
        return !_.isEmpty($field) && $field.parent().hasClass('richtext-container');
    }
    ...
    function setRTEField($field, value) {
        ...
        $field.val(value);
        $parent.find('.coral-RichText-editable').html(value);
    }
    ...
    function fillValue($form, fieldSetName, $field, counter) {
        ...
        if ($form.find('[type="hidden"][name="' + fieldSetName + '/' + counter + '/' + name + '"]').length) {
            return;
        }
    ...
    function collectDataFromFields() {
        ...
        function collectHandler() {
            ...
            var $fields, $field, $nestedMultiField;
