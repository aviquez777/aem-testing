...
public class BcapIncDivFieldNames {

    private static final Logger log = LoggerFactory.getLogger(BcapIncDivFieldNames.class);
    ...
    public void initModel() {
        String[] bcapIncDiv = systemConfigurationService.getBcapIncDivFieldNames();
