...
public class MarketsServed {
    ...
    private List<FilterValueInMartketsServed> filterValues = Collections.emptyList();
    ...
    @JsonProperty("FilterValues")
    public List<FilterValueInMartketsServed> getFilterValues() {
        return filterValues;
    }

    @JsonProperty("FilterValues")
    public void setFilterValues(List<FilterValueInMartketsServed> filterValues) {
