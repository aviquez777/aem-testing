...
public class Services {
    ...
    private List<FilterValueInServices> filterValues = Collections.emptyList();
    ...
    @JsonProperty("FilterValues")
    public List<FilterValueInServices> getFilterValues() {
        return filterValues;
    }

    @JsonProperty("FilterValues")
    public void setFilterValues(List<FilterValueInServices> filterValues) {
