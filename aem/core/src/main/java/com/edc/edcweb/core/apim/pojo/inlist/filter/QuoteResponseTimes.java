...
public class QuoteResponseTimes {
    ...
    private List<FilterValueInQuoteResponseTime> filterValues = Collections.emptyList();
    ...
    @JsonProperty("FilterValues")
    public List<FilterValueInQuoteResponseTime> getFilterValues() {
        return filterValues;
    }

    @JsonProperty("FilterValues")
    public void setFilterValues(List<FilterValueInQuoteResponseTime> filterValues) {
