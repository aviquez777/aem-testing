...
public class ServiceTypes {
    ...
    private List<FilterValueInServiceType> filterValues = Collections.emptyList();
    ...
    @JsonProperty("FilterValues")
    public List<FilterValueInServiceType> getFilterValues() {
        return filterValues;
    }

    @JsonProperty("FilterValues")
    public void setFilterValues(List<FilterValueInServiceType> filterValues) {
