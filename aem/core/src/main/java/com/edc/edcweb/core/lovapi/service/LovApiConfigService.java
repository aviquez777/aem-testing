...
public interface LovApiConfigService {
    ...
    /**
     * Get the FI LOV end point URL which is Environment / LOV dependent
     *
     * @return String with the getFiEndpoint
     */
    String getFiEndpoint();

    /**
     * Get the MMG Form end point
     *
     * @return MMG Form end point
     */

    String getMmgFormFiEndPoint();

    /**
     * Get the BCAP Form end point
     *
     * @return BCAP Form end point
     */
    String getBcapFormFiEndPoint();

    /**
     * Get the TELP Form end point
     *
     * @return TELP Form end point
     */
