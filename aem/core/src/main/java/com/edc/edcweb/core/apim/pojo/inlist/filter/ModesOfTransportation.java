...
public class ModesOfTransportation {
    ...
    private Integer parentFilterSectionId;
    @JsonProperty("ParentFilterValueKeyName")
    private String parentFilterValueKeyName;
    @JsonProperty("FilterValues")
    private List<FilterValueInModesOfTransportation> filterValues = Collections.emptyList();
    ...
    @JsonProperty("ParentFilterSectionId")
    public Integer getParentFilterSectionId() {
        return parentFilterSectionId;
    }

    @JsonProperty("ParentFilterSectionId")
    public void setParentFilterSectionId(Integer parentFilterSectionId) {
        this.parentFilterSectionId = parentFilterSectionId;
    }

    @JsonProperty("ParentFilterValueKeyName")
    public String getParentFilterValueKeyName() {
        return parentFilterValueKeyName;
    }

    @JsonProperty("ParentFilterValueKeyName")
    public void setParentFilterValueKeyName(String parentFilterValueKeyName) {
        this.parentFilterValueKeyName = parentFilterValueKeyName;
    }

    @JsonProperty("FilterValues")
    public List<FilterValueInModesOfTransportation> getFilterValues() {
        return filterValues;
    }

    @JsonProperty("FilterValues")
    public void setFilterValues(List<FilterValueInModesOfTransportation> filterValues) {
