...
public class LeftHandNavigationNew {

    private static final Logger log = LoggerFactory.getLogger(LeftHandNavigationNew.class);
    @Inject
    @Source("sling-object")
    ...
    public void initModel() {
        ...
        if (contentPolicy != null) {
            ...
            expandLabel = properties.get(Constants.Properties.EXPAND_ARIA_LABEL, "");
        }
        ...
        if (StringUtils.isNotBlank(startingPage)) {
